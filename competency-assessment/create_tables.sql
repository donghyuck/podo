	...
	CA_COMPETENCY_PROPERTY ON TABLE  "CA_COMPETENCY_PROPERTY"  IS '역량 프로퍼티 테이블';
	CA_COMPETENCY_PROPERTY ON COLUMN "CA_COMPETENCY_PROPERTY"."COMPETENCY_ID" IS '역량 ID'; 
	CA_COMPETENCY_PROPERTY ON COLUMN "CA_COMPETENCY_PROPERTY"."PROPERTY_NAME" IS '프로퍼티 이름'; 
	CA_COMPETENCY_PROPERTY ON COLUMN "CA_COMPETENCY_PROPERTY"."PROPERTY_VALUE" IS '프로퍼티 값'; 			
