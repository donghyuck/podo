	...
	CREATE TABLE CA_ASSESSED_SCORE (
		...
		CONSTRAINT CA_ASSESSED_SCORE_PK PRIMARY KEY (ASSESSMENT_ID, CANDIDATE_ID, ASSESSOR_ID, COMPETENCY_ID, ESSENTIAL_ELEMENT_ID, PERFORMANCE_CRITERIA_ID )
	);	
	
	--alter table CA_ASSESSED_SCORE add(SCORE INTEGER DEFAULT 0);	
	
	-- =================================================  
	--  CA_ASSESSMENT
	-- =================================================	
	CREATE TABLE CA_ASSESSMENT (
		ASSESSMENT_ID 			INTEGER NOT NULL,
		ASSESSMENT_PLAN_ID		INTEGER NOT NULL,
		FEEDBACK_ENABLED		NUMBER(1,0) DEFAULT 0, 		
		CANDIDATE_ID 			INTEGER NOT NULL,
		...
		CREATION_DATE			TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
		MODIFIED_DATE			TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,		
		CONSTRAINT CA_ASSESSMENT_PK PRIMARY KEY (ASSESSMENT_ID)
	);
	
	--alter table CA_ASSESSMENT add(TOTAL_SCORE INTEGER DEFAULT 0);	
	CREATE INDEX CA_ASSESSMENT_IDX01 ON CA_ASSESSMENT (ASSESSMENT_PLAN_ID) ;
	CREATE INDEX CA_ASSESSMENT_IDX02 ON CA_ASSESSMENT (ASSESSMENT_PLAN_ID, STATE) ;
	CREATE INDEX CA_ASSESSMENT_IDX03 ON CA_ASSESSMENT (ASSESSMENT_PLAN_ID, FEEDBACK_ENABLED) ;


	CREATE TABLE CA_ASSESSMENT_PLAN (
		ASSESSMENT_ID 			INTEGER NOT NULL,
		OBJECT_TYPE				INTEGER NOT NULL,
		OBJECT_ID				INTEGER NOT NULL,		
		NAME					VARCHAR2(255) NOT NULL,
		DESCRIPTION				VARCHAR2(4000),
		RATING_SCHEME_ID     	INTEGER NOT NULL,		
		MULTIPLE_APPLY_ALLOWED 	NUMBER(1,0) DEFAULT 0, 
		FEEDBACK_ENABLED		NUMBER(1,0) DEFAULT 0, 		
		STATE					VARCHAR2(20), 
		...
		CREATION_DATE			TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
		MODIFIED_DATE			TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,		
		CONSTRAINT CA_ASSESSMENT_PLAN_PK PRIMARY KEY (ASSESSMENT_ID)
	);

	CREATE INDEX CA_ASSESSMENT_PLAN_IDX1 ON CA_ASSESSMENT_PLAN (OBJECT_TYPE, OBJECT_ID) ;
	CREATE INDEX CA_ASSESSMENT_PLAN_IDX2 ON CA_ASSESSMENT_PLAN (OBJECT_TYPE, OBJECT_ID, START_DATE, END_DATE) ;
	CREATE INDEX CA_ASSESSMENT_PLAN_IDX3 ON CA_ASSESSMENT_PLAN (OBJECT_TYPE, OBJECT_ID, STATE) ;
	CREATE INDEX CA_ASSESSMENT_PLAN_IDX4 ON CA_ASSESSMENT_PLAN (OBJECT_TYPE, OBJECT_ID, STATE, START_DATE, END_DATE) ;
	
	
	CREATE TABLE CA_ASSESSMENT_PLAN_PROPERTY (
	  ASSESSMENT_ID               INTEGER NOT NULL,
	  PROPERTY_NAME          VARCHAR2(100)   NOT NULL,
	  PROPERTY_VALUE         VARCHAR2(1024)  NOT NULL,
	  CONSTRAINT CA_ASSESSMENT_PLAN_PROPERTY_PK PRIMARY KEY (ASSESSMENT_ID, PROPERTY_NAME)
	);	
	
	-- =================================================  
	--  RATING SCHEME
	-- =================================================	
	CREATE TABLE CA_RATING_SCHEME (
		RATING_SCHEME_ID			INTEGER NOT NULL,
		OBJECT_TYPE			INTEGER NOT NULL,
		OBJECT_ID			INTEGER NOT NULL,	
		NAME				VARCHAR2(255) NOT NULL,
		...
		CREATION_DATE		TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
		MODIFIED_DATE		TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,	
		CONSTRAINT CA_RATING_SCHEME_PK PRIMARY KEY (RATING_SCHEME_ID)
	);
	
	CREATE INDEX CA_RATING_SCHEME_IDX1 ON CA_RATING_SCHEME (OBJECT_TYPE, OBJECT_ID) ;
	
	CREATE TABLE CA_RATING_SCHEME_PROPERTY (
	  RATING_SCHEME_ID               INTEGER NOT NULL,
	  PROPERTY_NAME          VARCHAR2(100)   NOT NULL,
	  PROPERTY_VALUE         VARCHAR2(1024)  NOT NULL,
	  CONSTRAINT CA_RATING_SCHEME_PROPERTY_PK PRIMARY KEY (RATING_SCHEME_ID, PROPERTY_NAME)
	);	

	CREATE TABLE CA_RATING_LEVEL (
		RATING_SCHEME_ID			INTEGER NOT NULL,
		RATING_LEVEL_ID				INTEGER NOT NULL,
		TITLE				VARCHAR2(512) NOT NULL,
		SCORE				INTEGER NOT NULL,	
		CONSTRAINT CA_RATING_LEVEL_PK PRIMARY KEY (RATING_LEVEL_ID)
	);
	CREATE INDEX CA_RATING_LEVEL_IDX1 ON CA_RATING_LEVEL (RATING_SCHEME_ID) ;
	
	-- =================================================  
	--  ASSESSMENT SCHEME
	-- =================================================	
	
	CREATE TABLE CA_ASSESSMENT_SCHEME (
		...
		CREATION_DATE			TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
		MODIFIED_DATE			TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,	
		CONSTRAINT CA_ASSESSMENT_SCHEME_PK PRIMARY KEY (ASSESSMENT_SCHEME_ID)	
	);
	CREATE INDEX CA_ASSESSMENT_SCHEME_IDX1 ON CA_ASSESSMENT_SCHEME (OBJECT_TYPE, OBJECT_ID) ;
	CREATE TABLE CA_ASSESSMENT_SCHEME_PROPERTY (
	  ASSESSMENT_SCHEME_ID   INTEGER NOT NULL,
	  PROPERTY_NAME          VARCHAR2(100)   NOT NULL,
	  PROPERTY_VALUE         VARCHAR2(1024)  NOT NULL,
	  CONSTRAINT CA_ASSESSMENT_SCHEME_PROP_PK PRIMARY KEY (ASSESSMENT_SCHEME_ID, PROPERTY_NAME)
	);	
	
	--alter table CA_ASSESSMENT_SCHEME add(FEEDBACK_ENABLED NUMBER(1,0) DEFAULT 0);	
	
	
CREATE TABLE CA_ASSESSMENT_JOB_SELECTION (
		SELECTION_ID		INTEGER NOT NULL, 
		SELECTION_TYPE		INTEGER NOT NULL, 
		OBJECT_TYPE			INTEGER NOT NULL,
		OBJECT_ID			INTEGER NOT NULL,			
		CLASSIFY_TYPE  		INTEGER NOT NULL,
		L_CLASSIFIED_ID		INTEGER NOT NULL,
		M_CLASSIFIED_ID		INTEGER NOT NULL,
		S_CLASSIFIED_ID		INTEGER NOT NULL,
		JOB_ID				INTEGER NOT NULL,
		CONSTRAINT CA_ASSESSMENT_JOB_SELECTION_PK PRIMARY KEY (SELECTION_ID));

	CREATE INDEX CA_ASSESSMENT_JOB_SEL_IDX1 ON CA_ASSESSMENT_JOB_SELECTION (OBJECT_TYPE, OBJECT_ID);
	
	CREATE TABLE CA_ASSESSMENT_COMPETENCY (
		SELECTION_ID		INTEGER NOT NULL,
		SELECTION_TYPE		INTEGER NOT NULL, 
		OBJECT_TYPE			INTEGER NOT NULL,
		OBJECT_ID			INTEGER NOT NULL,			
		COMPETENCY_GROUP_CODE	VARCHAR2(100),
		COMPETENCY_ID		INTEGER NOT NULL,
		CONSTRAINT CA_ASSESSMENT_COMPETENCY_PK PRIMARY KEY (SELECTION_ID));
	
	CREATE INDEX CA_ASSESSMENT_COMPETENCY_IDX1 ON CA_ASSESSMENT_COMPETENCY (OBJECT_TYPE, OBJECT_ID) ;


	CREATE TABLE CA_ASSESSMENT_SUBJECT (
		SUBJECT_ID		INTEGER NOT NULL,
		OBJECT_TYPE			INTEGER NOT NULL,
		OBJECT_ID			INTEGER NOT NULL,			
		SUBJECT_OBJECT_TYPE			INTEGER NOT NULL,
		SUBJECT_OBJECT_ID			INTEGER NOT NULL,	
		CONSTRAINT CA_ASSESSMENT_SUBJECT_PK PRIMARY KEY (SUBJECT_ID));

	CREATE INDEX CA_ASSESSMENT_SUBJECT_IDX1 ON CA_ASSESSMENT_SUBJECT (OBJECT_TYPE, OBJECT_ID) ;
	CREATE INDEX CA_ASSESSMENT_SUBJECT_IDX2 ON CA_ASSESSMENT_SUBJECT (SUBJECT_OBJECT_TYPE, SUBJECT_OBJECT_ID) ;
	...
	CREATE TABLE CA_JOB (
		...
		CREATION_DATE		TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
		MODIFIED_DATE		TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,	
		CONSTRAINT CA_JOB_PK PRIMARY KEY (JOB_ID)
	);	
	
	CREATE INDEX CA_JOB_IDX1 ON CA_JOB (OBJECT_TYPE, OBJECT_ID) ;
	CREATE INDEX CA_JOB_IDX2 ON CA_JOB (OBJECT_TYPE, OBJECT_ID, L_CLASSIFIED_ID) ;
	CREATE INDEX CA_JOB_IDX3 ON CA_JOB (OBJECT_TYPE, OBJECT_ID, L_CLASSIFIED_ID, M_CLASSIFIED_ID) ;
	CREATE INDEX CA_JOB_IDX4 ON CA_JOB (OBJECT_TYPE, OBJECT_ID, L_CLASSIFIED_ID, M_CLASSIFIED_ID, S_CLASSIFIED_ID) ;
	CREATE INDEX CA_JOB_IDX5 ON CA_JOB (OBJECT_TYPE, OBJECT_ID, NAME) ;

	CREATE INDEX CA_JOB_IDX6 ON CA_JOB (OBJECT_TYPE, OBJECT_ID, CLASSIFY_TYPE, L_CLASSIFIED_ID) ;
	CREATE INDEX CA_JOB_IDX7 ON CA_JOB (OBJECT_TYPE, OBJECT_ID, CLASSIFY_TYPE, L_CLASSIFIED_ID, M_CLASSIFIED_ID) ;
	CREATE INDEX CA_JOB_IDX8 ON CA_JOB (OBJECT_TYPE, OBJECT_ID, CLASSIFY_TYPE, L_CLASSIFIED_ID, M_CLASSIFIED_ID, S_CLASSIFIED_ID) ;
	CREATE INDEX CA_JOB_IDX9 ON CA_JOB (OBJECT_TYPE, OBJECT_ID, CLASSIFY_TYPE, NAME) ;
	
	--alter table CA_JOB add(CLASSIFY_TYPE INTEGER DEFAULT 0 NOT NULL);	
	
	CREATE TABLE CA_JOB_PROPERTY (
	  JOB_ID               INTEGER NOT NULL,
	  PROPERTY_NAME          VARCHAR2(100)   NOT NULL,
	  PROPERTY_VALUE         VARCHAR2(1024)  NOT NULL,
	  CONSTRAINT CA_JOB_PROPERTY_PK PRIMARY KEY (JOB_ID, PROPERTY_NAME)
	);	
   
	COMMENT ON TABLE  CA_JOB_PROPERTY  IS '직무 프로퍼티 테이블';
	COMMENT ON COLUMN "CA_JOB_PROPERTY"."JOB_ID" IS '직무 ID'; 
	COMMENT ON COLUMN "CA_JOB_PROPERTY"."PROPERTY_NAME" IS '프로퍼티 이름'; 
	COMMENT ON COLUMN "CA_JOB_PROPERTY"."PROPERTY_VALUE" IS '프로퍼티 값'; 		
	
	CREATE TABLE CA_JOB_COMPETENCY_REL (
		OBJECT_TYPE			INTEGER NOT NULL,
		OBJECT_ID			INTEGER NOT NULL,		
		JOB_ID				INTEGER NOT NULL,
		JOB_LEVEL_ID		INTEGER NOT NULL,
		COMPETENCY_ID		INTEGER NOT NULL,
		CONSTRAINT CA_JOB_COMPETENCY_REL_PK PRIMARY KEY (JOB_ID, JOB_LEVEL_ID, COMPETENCY_ID)
	);
	
	CREATE INDEX CA_JOB_COMPETENCY_REL_IDX1 ON CA_JOB_COMPETENCY_REL (OBJECT_TYPE, OBJECT_ID) ;
	CREATE INDEX CA_JOB_COMPETENCY_REL_IDX2 ON CA_JOB_COMPETENCY_REL (OBJECT_TYPE, OBJECT_ID, JOB_ID) ;
	CREATE INDEX CA_JOB_COMPETENCY_REL_IDX3 ON CA_JOB_COMPETENCY_REL (OBJECT_TYPE, OBJECT_ID, COMPETENCY_ID) ;
	CREATE INDEX CA_JOB_COMPETENCY_REL_IDX4 ON CA_JOB_COMPETENCY_REL (OBJECT_TYPE, OBJECT_ID, JOB_ID, JOB_LEVEL_ID ) ;
	
	-- alter table CA_JOB_COMPETENCY_REL add(JOB_LEVEL_ID INTEGER DEFAULT 0 NOT NULL);	
	
	-- ALTER TABLE CA_JOB_COMPETENCY_REL DROP CONSTRAINT CA_JOB_COMPETENCY_REL_PK;

	-- ALTER TABLE CA_JOB_COMPETENCY_REL ADD CONSTRAINT CA_JOB_COMPETENCY_REL_PK PRIMARY KEY (JOB_ID, JOB_LEVEL_ID, COMPETENCY_ID);

	
	CREATE TABLE CA_JOB_LEVEL (
		JOB_LEVEL_ID 		INTEGER NOT NULL,	
		JOB_ID				INTEGER NOT NULL,
		NAME				VARCHAR2(255) NOT NULL,
		DESCRIPTION			VARCHAR2(4000),
		...
		JOB_LEVEL 			INTEGER NOT NULL,	
		IS_STRONG_REL		NUMBER(1, 0)  DEFAULT 0,
		CONSTRAINT CA_JOB_LEVEL_PK PRIMARY KEY (JOB_LEVEL_ID)
	);	
	
	CREATE INDEX CA_JOB_LEVEL_IDX1 ON CA_JOB_LEVEL (JOB_ID) ;
	
	-- alter table CA_JOB_LEVEL add( IS_STRONG_REL NUMBER(1, 0)  DEFAULT 0);	
	
	
	-- =================================================  
	--  CA_COMPETENCY	
	-- =================================================	
	CREATE TABLE CA_COMPETENCY (
		COMPETENCY_ID		INTEGER NOT NULL,
		COMPETENCY_TYPE		INTEGER DEFAULT 0 NOT NULL,
		OBJECT_TYPE			INTEGER NOT NULL,
		OBJECT_ID			INTEGER NOT NULL,	
		NAME				VARCHAR2(255) NOT NULL,
		DESCRIPTION			VARCHAR2(4000),
		COMPETENCY_LEVEL 		INTEGER NOT NULL,
		COMPETENCY_UNIT_CODE	VARCHAR2(100),
		COMPETENCY_GROUP_CODE	VARCHAR2(100),
		COMPETENCY_CLASSIFY_SYSTEM_ID INTEGER NOT NULL,
		CONSTRAINT CA_COMPETENCY_PK PRIMARY KEY (COMPETENCY_ID)
	);	
	
	CREATE INDEX CA_COMPETENCY_IDX1 ON CA_COMPETENCY (OBJECT_TYPE, OBJECT_ID) ;
	
	CREATE INDEX CA_COMPETENCY_IDX2 ON CA_COMPETENCY (OBJECT_TYPE, OBJECT_ID, NAME) ;
	
	CREATE INDEX CA_COMPETENCY_IDX3 ON CA_COMPETENCY (OBJECT_TYPE, OBJECT_ID, COMPETENCY_UNIT_CODE) ;
	
	CREATE INDEX CA_COMPETENCY_IDX4 ON CA_COMPETENCY (OBJECT_TYPE, OBJECT_ID, COMPETENCY_TYPE) ;
	
	CREATE INDEX CA_COMPETENCY_IDX5 ON CA_COMPETENCY (OBJECT_TYPE, OBJECT_ID, COMPETENCY_GROUP_CODE) ;
	
	CREATE INDEX CA_COMPETENCY_IDX6 ON CA_COMPETENCY (OBJECT_TYPE, OBJECT_ID, COMPETENCY_CLASSIFY_SYSTEM_ID) ;
	
	CREATE INDEX CA_COMPETENCY_IDX7 ON CA_COMPETENCY (OBJECT_TYPE, OBJECT_ID, COMPETENCY_CLASSIFY_SYSTEM_ID, COMPETENCY_GROUP_CODE) ;
	
	--alter table CA_COMPETENCY add(COMPETENCY_TYPE INTEGER DEFAULT 0 NOT NULL);
	--alter table CA_COMPETENCY add(COMPETENCY_GROUP_CODE VARCHAR2(100));
	--alter table CA_COMPETENCY add(COMPETENCY_CLASSIFY_SYSTEM_ID INTEGER DEFAULT 0 NOT NULL);
	-- DROP INDEX CA_COMPETENCY_IDX6 ;
	-- ALTER TABLE CA_COMPETENCY DROP COLUMN COMPETENCY_CLASSIFY_SYSTEM;
	
	CREATE TABLE CA_COMPETENCY_PROPERTY (
	  COMPETENCY_ID               INTEGER NOT NULL,
	  PROPERTY_NAME          VARCHAR2(100)   NOT NULL,
	  PROPERTY_VALUE         VARCHAR2(1024)  NOT NULL,
	  CONSTRAINT CA_COMPETENCY_PROPERTY_PK PRIMARY KEY (COMPETENCY_ID, PROPERTY_NAME)
	);	
	
	COMMENT ON TABLE  "CA_COMPETENCY_PROPERTY"  IS '역량 프로퍼티 테이블';
	COMMENT ON COLUMN "CA_COMPETENCY_PROPERTY"."COMPETENCY_ID" IS '역량 ID'; 
	COMMENT ON COLUMN "CA_COMPETENCY_PROPERTY"."PROPERTY_NAME" IS '프로퍼티 이름'; 
	COMMENT ON COLUMN "CA_COMPETENCY_PROPERTY"."PROPERTY_VALUE" IS '프로퍼티 값'; 			
	
	
	
	CREATE TABLE CA_ESSENTIAL_ELEMENT (
		COMPETENCY_ID			INTEGER NOT NULL,
		ESSENTIAL_ELEMENT_ID			INTEGER NOT NULL,	
		NAME				VARCHAR2(255) NOT NULL,
		DESCRIPTION			VARCHAR2(4000),
		COMPETENCY_LEVEL 				INTEGER NOT NULL,	
		CONSTRAINT CA_ESSENTIAL_ELEMENT_PK PRIMARY KEY (ESSENTIAL_ELEMENT_ID)
	);	
	
	CREATE INDEX CA_ESSENTIAL_ELEMENT_IDX1 ON CA_ESSENTIAL_ELEMENT (COMPETENCY_ID) ;
	
	
	CREATE TABLE CA_ESSENTIAL_ELEMENT_PROPERTY (
	  ESSENTIAL_ELEMENT_ID               INTEGER NOT NULL,
	  PROPERTY_NAME          VARCHAR2(100)   NOT NULL,
	  PROPERTY_VALUE         VARCHAR2(1024)  NOT NULL,
	  CONSTRAINT CA_ESSENTIAL_ELEMENT_PROP_PK PRIMARY KEY (ESSENTIAL_ELEMENT_ID, PROPERTY_NAME)
	);	
	
	
	CREATE TABLE CA_PERFORMANCE_CRITERIA (
		PERFORMANCE_CRITERIA_ID			INTEGER NOT NULL,
		OBJECT_TYPE			INTEGER NOT NULL,
		OBJECT_ID			INTEGER NOT NULL,	
		...
		CREATION_DATE		TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
		MODIFIED_DATE		TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,	
		CONSTRAINT CA_PERFORMANCE_CRITERIA_PK PRIMARY KEY (PERFORMANCE_CRITERIA_ID)
	);
		
	CREATE INDEX CA_PERFORMANCE_CRITERIA_IDX1 ON CA_PERFORMANCE_CRITERIA (OBJECT_TYPE, OBJECT_ID) ;
	
	CREATE TABLE CA_PERFORMANCE_CRITERIA_PROP (
	  PERFORMANCE_CRITERIA_ID INTEGER NOT NULL,
	  PROPERTY_NAME           VARCHAR2(100)   NOT NULL,
	  PROPERTY_VALUE          VARCHAR2(1024)  NOT NULL,
	  CONSTRAINT CA_PERFE_CRITERIA_PROP_PK PRIMARY KEY (PERFORMANCE_CRITERIA_ID, PROPERTY_NAME)
	);	
	
	COMMENT ON TABLE  "CA_PERFORMANCE_CRITERIA_PROP"  IS 'PERFORMANCE CRITERIA 프로퍼티 테이블';
	COMMENT ON COLUMN "CA_PERFORMANCE_CRITERIA_PROP"."PERFORMANCE_CRITERIA_ID" IS 'PERFORMANCE CRITERIA ID'; 
	COMMENT ON COLUMN "CA_PERFORMANCE_CRITERIA_PROP"."PROPERTY_NAME" IS '프로퍼티 이름'; 
	COMMENT ON COLUMN "CA_PERFORMANCE_CRITERIA_PROP"."PROPERTY_VALUE" IS '프로퍼티 값'; 	
	
	-- alter table CA_PERFORMANCE_CRITERIA add(SORT_ORDER			INTEGER DEFAULT 0 NOT NULL);

	CREATE TABLE CA_ABILITY (
		ABILITY_ID			INTEGER NOT NULL,
		OBJECT_TYPE			INTEGER NOT NULL,
		OBJECT_ID			INTEGER NOT NULL,	
		ABILITY_TYPE		INTEGER DEFAULT 0 NOT NULL,
		NAME				VARCHAR2(255) NOT NULL,
		DESCRIPTION			VARCHAR2(4000),
		CONSTRAINT CA_ABILITY_PK PRIMARY KEY (ABILITY_ID)
	);
		
	CREATE INDEX CA_ABILITY_IDX1 ON CA_ABILITY (OBJECT_TYPE, OBJECT_ID) ;
	
	-- =================================================  
	--  STANDARD CODE	
	-- =================================================	
	CREATE TABLE CA_CODESET (
		...
		CREATION_DATE		TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
		MODIFIED_DATE		TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
		CONSTRAINT CA_CODESET_PK PRIMARY KEY (CODESET_ID)
	);
	
	CREATE INDEX CA_CODESET_IDX1 ON CA_CODESET (OBJECT_TYPE, OBJECT_ID) ;
	CREATE INDEX CA_CODESET_IDX2 ON CA_CODESET (PARENT_CODESET_ID) ;
	CREATE INDEX CA_CODESET_IDX3 ON CA_CODESET (OBJECT_TYPE, OBJECT_ID, NAME) ;
	CREATE INDEX CA_CODESET_IDX4 ON CA_CODESET (OBJECT_TYPE, OBJECT_ID, GROUP_CODE) ;
	...
	CREATE TABLE CA_CODESET_PROPERTY (
	  CODESET_ID             INTEGER NOT NULL,
	  PROPERTY_NAME          VARCHAR2(100)   NOT NULL,
	  PROPERTY_VALUE         VARCHAR2(1024)  NOT NULL,
	  CONSTRAINT CA_CODESET_PROPERTY_PK PRIMARY KEY (CODESET_ID, PROPERTY_NAME)
	);	
	
	COMMENT ON TABLE  "CA_CODESET_PROPERTY"  IS '코드 프로퍼티 테이블';
	COMMENT ON COLUMN "CA_CODESET_PROPERTY"."CODESET_ID" IS '코드 ID'; 
	COMMENT ON COLUMN "CA_CODESET_PROPERTY"."PROPERTY_NAME" IS '프로퍼티 이름'; 
	COMMENT ON COLUMN "CA_CODESET_PROPERTY"."PROPERTY_VALUE" IS '프로퍼티 값';
	
	
	
	
	CREATE TABLE CA_STD_CODE_VALUE (
