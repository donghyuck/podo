	...
	CREATE TABLE CA_ASSESSMENT (
		...
		START_DATE			DATE DEFAULT STSDATE NOT NULL,
		END_DATE			DATE DEFAULT STSDATE NOT NULL,		
	...
	CREATE INDEX CA_ASSESSMENT_IDX1 ON CA_ASSESSMENT (OBJECT_TYPE, OBJECT_ID) ;
	CREATE INDEX CA_ASSESSMENT_IDX2 ON CA_ASSESSMENT (OBJECT_TYPE, OBJECT_ID, START_DATE, END_DATE) ;
	
	CREATE TABLE CA_ASSESSMENT_PROPERTY (
	  ASSESSMENT_ID               INTEGER NOT NULL,
	  PROPERTY_NAME          VARCHAR2(100)   NOT NULL,
	  PROPERTY_VALUE         VARCHAR2(1024)  NOT NULL,
	  CONSTRAINT CA_ASSESSMENT_PROPERTY_PK PRIMARY KEY (ASSESSMENT_ID, PROPERTY_NAME)
	);	
