	...
	CREATE INDEX CA_ASSESSMENT_IDX1 ON CA_ASSESSMENT_PLAN (OBJECT_TYPE, OBJECT_ID) ;
	CREATE INDEX CA_ASSESSMENT_IDX2 ON CA_ASSESSMENT_PLAN (OBJECT_TYPE, OBJECT_ID, START_DATE, END_DATE) ;
	CREATE INDEX CA_ASSESSMENT_IDX3 ON CA_ASSESSMENT_PLAN (OBJECT_TYPE, OBJECT_ID, STATE) ;
	CREATE INDEX CA_ASSESSMENT_IDX4 ON CA_ASSESSMENT_PLAN (OBJECT_TYPE, OBJECT_ID, STATE, START_DATE, END_DATE) ;
