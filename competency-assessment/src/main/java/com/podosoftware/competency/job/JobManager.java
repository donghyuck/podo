...
public interface JobManager {
	...
	public abstract List<Job> getJobs(int objectType, long objectId, Classification classify) ;
	
	public abstract List<Job> getJobs(int objectType, long objectId, Classification classify, int startIndex, int numResults) ;	
