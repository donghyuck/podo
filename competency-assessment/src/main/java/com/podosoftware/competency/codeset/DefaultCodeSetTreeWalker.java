...
public class DefaultCodeSetTreeWalker implements CodeSetTreeWalker {
	...
	if (depth == -1)
	    throw new IllegalArgumentException((new StringBuilder()).append("CodeSet").append(comment.getCodeSetId())
    ...
    @Override
    public CodeSet getChild(CodeSet comment, int index) throws CodeSetNotFoundException {
