...
public interface CompetencyDao {
    ...
    public abstract List<Long> getCompetencyIds(int objectType, long objectId, String groupCode, int level, String name,
	    Classification classify, long jobId);

    public abstract List<Long> getCompetencyIds(int objectType, long objectId, String groupCode, int level, String name,
	    Classification classify, long jobId, int startIndex, int numResults);

    public abstract int getCompetencyCount(int objectType, long objectId, String groupCode, int level, String name,
	    Classification classify, long jobId);
     ...
     * @return
     */
    public abstract List<Long> getCompetencyIds(Company company, Classification classify, int startIndex,
	    int numResults);
