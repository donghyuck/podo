...
public interface CompetencyManager {
    ...
    public abstract Competency createCompetency(int objectType, long objectId, CompetencyType competencyType)
    ...
    public abstract Competency createCompetency(Company company, String name, String description)
	    throws CompetencyAlreadyExistsException;
    ...
    public abstract List<Competency> getCompetencies(Company company, CompetencyType competencyType, int startIndex,
	    int numResults);
    ...
    public abstract List<Competency> getCompetencies(Company company, Classification classify, int startIndex,
	    int numResults);
     ...
     * @return
     */
    public abstract List<Competency> findCompetency(Company company, String groupCode, int level, String name,
     ...
     * @return
     */
    public abstract int getCompetencyCount(Company company, String groupCode, int level, String name,
	    Classification classify, long jobId);
    ...
    public abstract void updateEssentialElement(EssentialElement essentialElement)
	    throws EssentialElementNotFoundException;
    ...
    public abstract PerformanceCriteria getPerformanceCriteria(long performanceCriteriaId)
	    throws PerformanceCriteriaNotFoundException;

    public abstract void saveOrUpdate(PerformanceCriteria performanceCriteria)
	    throws PerformanceCriteriaNotFoundException;
